...
#define IOEXP0_CONC_MASK       (IOEXP0_TANK_ALARM | IOEXP0_MIN_CONC_ALARM | IOEXP0_PUMP_ENABLE | IOEXP0_MAX_CONC_ALARM)
#define IOEXP0_TEMP_MASK       ( IOEXP0_MIN_TEMP_ALARM | IOEXP0_HEATER_ENABLE | IOEXP0_MAX_TEMP_ALARM)
